...
export default function Navbar() {
  ...
  // Lijeva strana - prve 4 stavke
  const leftNavItems = navItems.slice(0, 4); // Početna, O nama, Usluge, Tim

  // Desna strana - posljednje 2 stavke
  const rightNavItems = navItems.slice(-2); // Galerija, Kontakt
    ...
    <>
      ...
      >
        ...
        <nav className="hidden md:flex items-center space-x-8 lg:space-x-10">
          ...
          <button className="ml-4 relative px-6 py-3 bg-transparent text-gold font-medium rounded-md transition-all duration-300 group overflow-hidden border border-gold/30 hover:border-gold/50">
      ...
      >
        <nav className="flex flex-col space-y-6">
          ...
          <div className="flex flex-col space-y-6 pt-8">
            ...
            <button className="relative px-8 py-4 bg-transparent text-gold font-medium rounded-md transition-all duration-300 group overflow-hidden border border-gold/30 hover:border-gold/50 text-xl">
